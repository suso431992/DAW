...
public class P07_02 {
    ...
    static List<Alumno> clase1 = new LinkedList<>();
    static List<Modulo> modulos = new LinkedList<>();
    static Scanner tec = new Scanner(System.in);
    static String[] CABEZERA_ALUMNO = {"Nombre", "Apellido1", "Apellido2", "DNI", "NotaMediaFinal"};
    static String[] CABEZERA_MODULO = {"Nombre", "Apodo", "Numero de examenes"};
        ...
        while (!salir) {
            ...
            switch (opcion) {
                ...
                case 8: {
                    ...
                    System.out.printf("%2$24s %3$20s %1$20s %4$-5s %5$18s \n",
                        CABEZERA_ALUMNO[0], CABEZERA_ALUMNO[1], CABEZERA_ALUMNO[2], CABEZERA_ALUMNO[3], CABEZERA_ALUMNO[4]);
    ...
    private static boolean esPosValida(int Pos, List x) {
